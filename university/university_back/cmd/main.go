...
func main(){
	...
	e.GET("/attendanceBySubjectId/:id", my_hdlr.GetSubjectAttendance)
	e.GET("/attendanceByStudentId/:id", my_hdlr.GetStudentAttendance)
	e.POST("/attendance/subject", my_hdlr.PostSubjectAttendance)
